...
const Navbar = () => {
  const { activeMenu, setActiveMenu, isClicked, currentColor, handleClick, 
  ...
  return (
    <div className="flex justify-between p-2 md:mx-6 relative">
      ...
      <NavButton 
        ...
        <NavButton 
        title='Notification' customFunc={() => handleClick('notification')} 
        color={currentColor} icon={<RiNotification3Line />} />
        <TooltipComponent content='Profile' position='BottomCenter'>
          <div className='flex items-center gap-2 cursor-position p-1 hover:bg-light-gray rounded-lg'
